...
public extension String {
    ...
    /// - Parameter num: 每段长度
    /// - Returns: 结果集
    public func subStringWithNum(num: Int) -> [String] {
        let oldValue = self
        var result = [String]()
        //分成多少段
    ...
    static public let random_str_characters = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"
    static public func randomStr(len: Int) -> String {
        var ranStr = ""
        for _ in 0..<len {
    ...
    /**
     拼接url
     */
    public func appendUrl(_ nextUrl: String) -> String {
        if(self.contains("?")) {
            return self + "&" + nextUrl
        } else {
            return self + "?" + nextUrl
     ...
     */
    public func isCheckVersion(_ version: String) -> Bool {
        //数据可能为空
        if(version == "" || self == "") {
    ...
    ///
    /// returns: 时间
    public func dateValue(_ format: String) -> Foundation.Date? {
    ...
    public func stringByDeletingLastPathComponent() -> String {
    ...
    public func stringByExpandingTildeInPath() -> String {
        
        let newNstr = self as NSString
        return newNstr.expandingTildeInPath
    }
    
    public func stringByStandardizingPath() -> String {
        
        let newNstr = self as NSString
        return newNstr.standardizingPath
    }
    public func stringByResolvingSymlinksInPath() -> String {
    ...
    /**
     ...
     - returns: string
     */
    public func stringFormatterCurrency() -> String {
    ...
    public func longLongValue() -> Int64 {
     ...
     */
    public func toDate(_ format: String? = "yyyy-MM-dd") -> Foundation.Date? {
        let text = self.removeSpaces().lowercased()
    ...
    /**
     ...
     - returns: 解析NSDate 如果不是的话，就为空
     */
    public func toDateTime(_ format: String? = "yyyy-MM-dd HH-mm-ss") -> Foundation.Date? {
    ...
    /**
     ...
     - returns: Stripped string
     */
    public func removeLeftSpaces(_ str: String) -> String {
    ...
    /**
     ...
     - returns: Stripped string
     */
    public func removeRightSpaces(_ str: String) -> String {
...
public extension String {
    ...
    public var toNumber_32Bit: NSNumber {
...
public extension String {
    ...
    public func replaceCharacterWith(_ characters: String, toSeparator: String) -> String {
    ...
    public func wipeCharacters(_ characters: String) -> String {
        return self.replaceCharacterWith(characters, toSeparator: "")
    }
    
    public func replace(find findStr: String, replaceStr: String) -> String {
    ...
    /**
     判断是不是英文或者数字
     */
    public func isEnglishOrNumber() -> Bool {
     ...
     */
    public func checkObjectType() -> ObjectType {
        switch self {
    ...
    /**
     ...
     - returns: 返回数字字符串
     */
    public func getNumberForString() -> String {
...
public extension String {
    ...
    /**
     ...
     - returns: 实例对象
     */
    public func classFromString() -> NSObject? {
...
public extension String {
    ...
    public func iconUrlIsEqualTo(_ otherUrl: String) -> Bool {
